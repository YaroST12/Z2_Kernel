...
static int headset_standard_get_parm_set(const char *val, struct kernel_param *kp)
{
	...
	if (headset_standard_get == 1) {
		if (gnd_mic_gpio_state == -1)
...
module_param_call(headset_standard_get,
				  headset_standard_get_parm_set, param_get_int,
...
module_param_call(headset_type_standard,
				  headset_type_standard_parm_set, param_get_int,
